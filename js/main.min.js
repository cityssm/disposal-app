...
nanoajax.ajax({url:"data/itemJSON.asp?k="+encodeURIComponent(c),responseType:"json"},function(c,a){k.innerHTML=a.success?'<h1 class="h1 pb1 border-bottom">'+a.itemName+'</h1><div class="clearfix px1">'+(""===a.pictureURL?"":'<img class="right fit" src="item-img/'+a.pictureURL+'" alt="'+a.itemName+'" />')+"<p>"+a.shortDescription+"</p>"+(""===a.longDescription?"":"<p>"+a.longDescription+"</p>")+"</div>"+(0===a.reuseIdeas.length?"":'<h2 class="pb1 border-bottom"><i class="fas fa-recycle" aria-hidden="true"></i> Reuse Ideas</h2>'+
