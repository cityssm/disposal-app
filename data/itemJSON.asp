<!--#include file="settings.asp"--><!--#include file="functions.asp"--><%
  ...
  if (rs.EOF) then
    ...
    sql = "select l.*" & _
      ...
      " left join itemLocations.csv il on l.LocationKey = il.LocationKey" & _
      " where il.ItemKey = ?" & _
    ...
    do until rs.EOF
      ...
      response.write ("{" & _
        ...
        ",""locationName"":""" & str_toJSON(rs.Fields.Item("LocationName")) & """" & _
        ",""address"":""" & str_toJSON(rs.Fields.Item("Address")) & """" & _
        ",""latitude"":""" & str_toJSON(rs.Fields.Item("Latitude")) & """" & _
        ",""longitude"":""" & str_toJSON(rs.Fields.Item("Longitude")) & """" & _
        ",""shortDescription"":""" & str_toJSON(rs.Fields.Item("ShortDescription")) & """" & _
        ",""longDescription"":""" & str_toJSON(rs.Fields.Item("LongDescription")) & """" & _
        ",""websiteURL"":""" & str_toJSON(rs.Fields.Item("WebsiteURL")) & """" & _
        "}")
